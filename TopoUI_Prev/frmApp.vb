...
Public Class frmApp
	...
	Private Sub zzFillParcelFileList()
		...
		If msCurrentParcelFileName.Length <> 0 Then
			...
			Dim iItemIndex As Integer
         Dim dicRes As Dictionary(Of Integer, FDO.ParcelData) = FDO.TplnPolygonSet.GetParcelData(msCurrentParcelFileName, sClassName, New DMCommon.dmList())
			If dicRes IsNot Nothing Then

				Dim dicBlocks As System.Collections.Generic.SortedDictionary(Of Integer, Integer) = New System.Collections.Generic.SortedDictionary(Of Integer, Integer)()
				For Each oParcelData As FDO.ParcelData In dicRes.Values
	...
	Private Sub cmdOK_Click(sender As System.Object, e As System.EventArgs) Handles cmdOK.Click
		...
		Else
            ...
            Dim iMapThemeID As DMAcadExt.enMapTheme
               ...
               End If
               moFDO_Manager.imp_Set(sShapeFileName, sShapeFolderName, sClassName, Nothing, iMapThemeID, New DMCommon.dmList())
				End If
			End If
		End If
