...
Public Class frmUD_General
   ...
   Public Sub New(bDBSource As Boolean)
      ...
      zzInit()
      DMCommon.Debug.MsgBox("12_327k", Me.rdbPlanType1.Checked, Me.rdbPlanType2.Checked, Me.rdbPlanType9.Checked, Me.rdbPlanType12.Checked)
      zzSetAttribTags()
      zzInitAcadBlocks()
      DMCommon.Debug.MsgBox("12_327m", Me.rdbPlanType1.Checked, Me.rdbPlanType2.Checked, Me.rdbPlanType9.Checked, Me.rdbPlanType12.Checked)
      zzSetToolTip()
      ...
      DMCommon.Debug.MsgBox("12_327n", Me.rdbPlanType1.Checked, Me.rdbPlanType2.Checked, Me.rdbPlanType9.Checked, Me.rdbPlanType12.Checked)
   End Sub
   ...
   Private Sub zzSetPlanType()
      ...
      DMCommon.Debug.MsgBox("12_326", miProjectCode, miDetailNo, moProjectDataTable.Rows.Count, miPlanType)
      Select Case miPlanType
         ...
         Case 12
            Me.rdbPlanType12.Checked = True
      End Select
      DMCommon.Debug.MsgBox("12_327", Me.rdbPlanType1.Checked, Me.rdbPlanType2.Checked, Me.rdbPlanType9.Checked, Me.rdbPlanType12.Checked)
      '   MessageBox.Show(CStr(Me.rdbPlanType2.Checked) & vbCrLf & CStr(Me.rdbPlanType12.Checked), "05_460")
   End Sub
   ...
   Private Sub zzLoadProjectDataTable(bSchemaOnly As Boolean)
      ...
      End If
      DMCommon.Debug.MsgBox("12_325", miProjectCode, miDetailNo, moProjectDataTable.Rows.Count)
      zzSetPlanType()

      DMCommon.Debug.MsgBox("12_327a", Me.rdbPlanType1.Checked, Me.rdbPlanType2.Checked, Me.rdbPlanType9.Checked, Me.rdbPlanType12.Checked)
   End Sub
   ...
   Private Sub zzCalcInsertPoints()
      ...
      '  MessageBox.Show(CStr(mtStampInsPmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmoint.ToString()) & vbCrLf & mtEllipseInsPoint.ToString() & vbCrLf & mtGenInsPoint.ToString() & vbCrLf & mtNotesInsPoint.ToString(), "04_929")
   ...
   Private Sub zzParseDate(sAttribValue As String, ByRef oDatePic As DateTimePicker)
      ...
      Else
         Dim cultures() As System.Globalization.CultureInfo = {New System.Globalization.CultureInfo("en-US"), _
                                       New System.Globalization.CultureInfo("fr-FR"), _
                                       New System.Globalization.CultureInfo("it-IT"), _
   ...
   Private Sub cmdDrawFrame_Click(sender As Object, e As EventArgs) Handles cmdDrawFrame.Click
   ...
   Private Sub cmdSaveToDWG_Click(sender As Object, e As EventArgs) Handles cmdSaveToDWG.Click
      DMAcadExt.AcadDocument.DocLock(Autodesk.AutoCAD.ApplicationServices.DocumentLockMode.ExclusiveWrite, True)
      DMAcadExt.AcadTransaction.Start()
      DMAcadExt.AcadTransaction.OpenModelSpace(Autodesk.AutoCAD.DatabaseServices.OpenMode.ForWrite, False)
      Dim bCurrentLayerOK As Boolean
