...
Public Class frmColorSchemeEditor
	...
	Public Sub New(ByVal iMode As enColorEditorMode, ByVal bReadOnly As Boolean, Optional ByVal iLanduseID As Integer = 0, Optional ByVal iColorSchemeID As Integer = 0)
	...
	Private Sub zzUpdate()
		...
		'	MessageBox.Show(CStr(mtColorSchemeDB.ID) & ":" & CStr(mtColorScheme.ID) & vbCrLf & miFormMode.ToString(), "18_001")
