...
Public Class frmTopoActionsT
	...
	Private Sub zzInsertReport(ByVal oReport As BaseReport)
		...
		Select Case doSelectedReportItem.RepIndex
            ...
            TPlanGraph.TplnLot.GetMainData(doSelectedReportItem.TopoPurpose, iDataOption, iOverlayMethod, 0, oDataView, iaDataColumns, oaTotals)
			Case TPlServerDB.enResourceTheme.AcRepLotsM
            TPlanGraph.TplnLot.GetMainData(DMAcadExt.enTopoPurpose.Proposed, iDataOption, iOverlayMethod, 0, oDataView, iaDataColumns, oaTotals)
		...
		If oDataView IsNot Nothing Then
			...
			End If
		Else
			MessageBox.Show("Data was not found", "01_431")
	...
	Private Sub cmdColorset_Click(ByVal oSender As System.Object, ByVal e As System.EventArgs) Handles cmdColorEditor.Click
		If dfEditColorScheme Is Nothing Then
			dfEditColorScheme = New frmColorEditor(TopoManager.enColorEditorMode.Landuse, False)
	...
	Private Sub dfSelectLanduse_ChangeColorSet() Handles dfSelectLanduse.ChangeColorSet
		...
		End If
	End Sub
	Private Sub dfSelectLanduse_FormClosed(ByVal oSender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles dfSelectLanduse.FormClosed
		Try
	...
	Private Sub cmdSelectLanduse_Click(ByVal oSender As Object, ByVal e As System.EventArgs) Handles cmdSelectLanduse.Click
