...
Public Class ExcelAppExt
	...
	'C:\D\NetProjects2017\TopoSolution18\TopoUI\frmLotsFromShapes.vb
	Private ReadOnly mbMergeEnabled As Boolean = True
	...
	Private mfrmTextBox As frmTextBox
	'Private moTextBox As System.Windows.Forms.TextBox
	...
	End Sub
	Public Sub OpenTextBox()
		mfrmTextBox = New frmTextBox(20, 40)
		If DMCommon.Debug.Debug Then
			mfrmTextBox.Show()
		End If

		'moTextBox = mfrmTextBox.TextBox
		'	DMCommon.Debug.MsgBox("13_323", moTextBox.Lines.Length)
	End Sub
	Public ReadOnly Property TextBox As frmTextBox
		Get
			Return mfrmTextBox
		End Get
	End Property
	Public ReadOnly Property TextBoxExists As Boolean
		Get
			Return (mfrmTextBox IsNot Nothing)
		End Get
	End Property
...
#Enable Warning IDE1006 ' Naming Styles
		...
		If moExcelApp IsNot Nothing AndAlso moWorksheet IsNot Nothing Then
			...
			Catch oEx As Exception
				System.Windows.Forms.MessageBox.Show(oEx.Message & vbCrLf & "moWorksheet Is Nothing: " & CStr(moWorksheet Is Nothing) & vbCrLf & sCell & vbCrLf & CStr(iRowIndex) & ":" & CStr(iColIndex), "ExcelLog - GetRange_4")
			End Try
		End If

		If oRange Is Nothing Then
			'''''''System.Windows.Forms.MessageBox.Show(sCell & vbCrLf & CStr(iRowIndex) & ":" & CStr(iColIndex), "Range Is Nothing")
		Else

			'System.Windows.Forms.MessageBox.Show(sCell & vbCrLf & CStr(iRowIndex) & ":" & CStr(iColIndex), "Range Is OK")
...
#Disable Warning IDE1006 ' Naming Styles
	...
	End Sub
	Public Sub SetNumberFormatInRow(iRow As Integer, iCol As Integer, ParamArray oaNumberFormat() As System.Object)


		Dim oRange As Range
		For iValIndex As Integer = 0 To oaNumberFormat.GetUpperBound(0)
			Try
			...
			If oRange IsNot Nothing AndAlso Not String.IsNullOrEmpty(oaNumberFormat(iValIndex).ToString()) Then

				oRange.NumberFormat = oaNumberFormat(iValIndex)
...
#Enable Warning IDE1006 ' Naming Styles
		If moWorksheet IsNot Nothing Then
			...
			For iValIndex As Integer = 0 To oaValue.GetUpperBound(0)
				...
				End If
				'moTextBox.Lines(iRow) = oaValue(iValIndex).ToString()
			Next
		End If
...
#Enable Warning IDE1006 ' Naming Styles
	...
	Public Sub SetValue(iFirstColumn As Integer, sCaption As String, ParamArray oaValue() As System.Object)
		...
		Else
			DMCommon.Debug.MsgBox("190530_3", "moWorksheet IsNot Nothing", moWorksheet IsNot Nothing)
		End If
		...
		If moWorksheet IsNot Nothing Then
			...
			If oExcelObject IsNot Nothing Then
				Try
					oRange = CType(oExcelObject, Excel.Range)
				Catch oEx As Exception
					System.Windows.Forms.MessageBox.Show(oEx.Message, "Application - GetRange_2")
				End Try
