...
Public Class frmSelectLanduse
	...
	Private Sub zzEditColorScheme()
		If Me.lvwLanduses.SelectedItems.Count = 1 Then
			...
			End If
			Dim fColorEditor As frmColorEditor = New frmColorEditor(iMode, bReadOnly, iLanduseID, iColorSchemeID)
		...
		For Each oListViewItem As ListViewItemExt In oList
			...
			Select Case oListViewItem.Status
				...
				Case enItemStatus.Added
					...
					Catch oEx As Exception
						MessageBox.Show(oEx.Message & vbCrLf & oEx.StackTrace, "18_200")
					End Try
	...
	Private Sub zzSetMovedButtonsEnabled(ByVal bEnabled As Boolean)
		...
		End If
	End Sub
	Private Sub tsbSet_Click(ByVal oSender As Object, ByVal e As System.EventArgs) Handles tsbSet.Click
	...
	Private Sub lvwLanduses_DoubleClick(ByVal oSender As Object, ByVal e As System.EventArgs) Handles lvwLanduses.DoubleClick
	...
	Private Sub lvwLanduses_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) 'Handles lvwLanduses.MouseDown
