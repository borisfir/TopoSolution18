	...
	public class WButtonEdit : WControlBase
	{
	   ...
	   public event ButtonPressedEventHandler ButtonPressed   = null;
		...
		private void InitializeComponent()
		{
			...
			this.m_pTextBox = new DMObjects.WTextBoxBase();
			...
			//BF RightToLeft m_ButtonWidth
			//this.m_pTextBox.Location = new System.Drawing.Point(3, 2);
			this.m_pTextBox.Location = new System.Drawing.Point(m_ButtonWidth + 3, 2);
			this.m_pTextBox.Mask = DMObjects.WEditBox_Mask.Text;
			...
			// WButtonEdit
			// 
			this.Controls.AddRange(new System.Windows.Forms.Control[] {this.m_pTextBox});
			this.Name = "WButtonEdit";
			this.Size = new System.Drawing.Size(118, 20);
			this.MouseEnter += new System.EventHandler(this.WButtonEdit_MouseEnter);
		...
		#region function WButtonEdit_MouseEnter

		private void WButtonEdit_MouseEnter(object sender, System.EventArgs e)
...
return true;
		///////////////	return base.ProcessDialogKey(keyData);   Experiment
		}
		...
		protected bool IsMouseInButtonRect()
		{
			...
			if(rectButton.Contains(this.PointToClient(mPos))){
				...
				this.Cursor = Cursors.Hand;
					//new Cursor(this.GetType(), "H_MOVE.CUR");
