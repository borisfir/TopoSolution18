...
namespace DMObjects
{
	...
	public class WPopUpFormBase : System.Windows.Forms.Form
	{
		...
		public WComboPopupMode PopupMode;
		/// <summary>
		/// Designer support.
		/// </summary>
...
//			if (m_ParentForm == null)
				//m_ParentForm = m_Parent.Parent.FindForm();
	//		MsgBox("Can't create File" + "  "  + ex.Message).FindForm();
		...
		protected override void Dispose( bool disposing )
		{
			if( disposing )
			{
				...
				if(!object.ReferenceEquals(m_Parent.Parent,m_ParentForm) && (m_Parent.Parent !=null) ){
					m_Parent.Parent.MouseDown -= new System.Windows.Forms.MouseEventHandler(this.ParentFormMouseClick);
				}
