...
namespace DMObjects
{
	...
	public class WComboBox : WButtonEdit
	{
		...
		private int         m_DropDownWidth = 200;
		private int         m_VisibleItems  = 10;
		private WComboItems m_WComboItems   = null;
		private DMObjects.ItemDataDict moItemDataDict=null; 
		private DMObjects.ItemData  m_SelectedItem  = null;
		private int miSelectedKey=0;
		/// <summary>
		/// Default constructor.
		/// </summary>
		public WComboBox()
		...
		private void InitializeComponent()
		{
			...
			// m_pTextBox
			// 
			this.m_pTextBox.ProccessMessage += new DMObjects.WMessage_EventHandler(this.m_pTextBox_ProccessMessage);
			// 
			// WComboBox
			// 
		...
		{
			this.Text = e.Text;
			m_SelectedItem = e.itemData;
       //  miSelectedKey = e.itemData.ListIndex;
			this.SelectedKey=e.itemData.ListIndex;
		...
		private void ShowPopUp()
		{
			...
			m_WComboPopUp = new WComboPopUp(this,m_ViewStyle,moItemDataDict.Values,m_VisibleItems,this.Text,m_DropDownWidth,WComboPopupMode.TextBox);
		...
		public WComboItems Items
		{
			...
			set {m_WComboItems =value;}
		}
		public ItemDataDict ItemDict
		{
			get{ return moItemDataDict; }

			set {moItemDataDict =value;}
		}
		public void SetItemsFromArray (ArrayList ItemsArray)
		{
         m_WComboItems = new WComboItems(this,ItemsArray);
		}
		public void SetItemsFromArray (IList ItemsArray)
		{
			m_WComboItems = new WComboItems(this,(ArrayList)ItemsArray);
		}

		public DMObjects.ItemData SelectedItem
		{
		...
		public int SelectedIndex
		{
			...
			set{
				if(value > -1 && value < this.Items.Count){
					m_SelectedItem = this.Items.GetItemData(value);
					this.Text = m_SelectedItem.ListDispData;
				}
			}
		}
		public int SelectedKey
		{
			get
			{
				return (miSelectedKey); 	
			}

			set
			{
				if(moItemDataDict.Contains(value))
				{
					miSelectedKey=value;
					m_SelectedItem=moItemDataDict.GetItem(miSelectedKey);
					this.Text= m_SelectedItem.ListDispData;
				}
			}
		}
		public System.Object DBSelectedKey
		{
			get
			{
				return ((System.Object)miSelectedKey); 	
			}
			...
			{  
				...
				else
				{
					...
					if(moItemDataDict.Contains(iValue))
					{
						miSelectedKey=iValue;
						m_SelectedItem=moItemDataDict.GetItem(miSelectedKey);
						this.Text= m_SelectedItem.ListDispData;
					}
				}
		...
		////////	base.OnBindingContextChanged(null);
		}
