...
Public Class AcadDocument
   ...
   Private Shared mbMessageSended As Boolean
	...
	Public Shared Sub WriteMessage(ByVal sMsg As String, ByVal ParamArray oParams() As System.Object)
		...
		Catch oEx As Exception
			System.Windows.Forms.MessageBox.Show(oEx.Message, "AcadDocument - WriteMessage")
		End Try
	End Sub
   ...
   Public Shared Sub DocLock(ByVal bMode As DocumentLockMode, ByVal bCommandLine As Boolean)
      ...
      Else
		...
		End If
		'System.Windows.Forms.MessageBox.Show(CStr(moDocLock Is Nothing), "DocLock 12_411")
      ...
      Else
			...
			Catch oMapEx As Autodesk.Gis.Map.MapException
				AcadErrCode.ShowMapError(oMapEx.ErrorCode, False, "AcadDocument - DocLock")
			End Try
      End If
