...
Public Class frmPgonSetView
   ...
   Private Sub zzCreatePgonSet()
		'   MessageBox.Show(Me.Name & vbCrLf & "zzCreatePgonSet", "05_370b")
		Dim bCurrentLayerOK As Boolean = False

		' System.Windows.Forms.MessageBox.Show(mtSourceMapThemeData.MapThemeID.ToString & vbCrLf & mtSourceMapThemeData.TopoPurpose.ToString & vbCrLf & mtSourceMapThemeData.GraphType.ToString() & vbCrLf & mtSourceMapThemeData.TopoName & vbCrLf & mtSourceMapThemeData.ClosedPgonsLayers, "07_001v")
   ...
   Private Sub zzMarkDoubleName(oDataRow As Data.DataRowView, oMarkBlock As DMAcadExt.MarkBlock)
		Dim oVal As System.Object = oDataRow.Item(FDO.TplnPolygonSet.msCentroidAcObjIDFieldName)
		Dim sName As System.Object = oDataRow.Item(FDO.TplnPolygonSet.msNameFieldName)
   ...
   Private Sub frmPgonSetView_Load(oSender As System.Object, e As EventArgs) Handles Me.Load
      ...
      zzSetData()
		'   Dim o As System.Object = dgvPolygons.DataSource
