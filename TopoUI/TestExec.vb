...
#End Region
	...
	Private Sub InitializeDataGridView(ByVal oSender As System.Object, _
	...
	Private Sub reset(ByVal oSender As System.Object, _
	...
	Private Sub dataGridView1_CellClick(ByVal oSender As System.Object, _
	ByVal e As DataGridViewCellEventArgs) _
	Handles dataGridView1.CellClick

		If turn.Text.Equals(gameOverString) Then Return
		MessageBox.Show(CStr(xImage.GetUpperBound(0)), "UB of xImage")
		...
		If (cell.Value Is blank) Then
			If IsOsTurn() Then
				cell.Value = o
				MessageBox.Show(CStr(oImage.GetUpperBound(0)), "UB of oImage")
			Else
				cell.Value = x
				MessageBox.Show(CStr(xImage.GetUpperBound(0)), "UB of xImage")
			End If
	...
	Private Sub dataGridView1_CellMouseEnter(ByVal oSender As System.Object, _
	ByVal e As DataGridViewCellEventArgs) _
	...
	Private Sub dataGridView1_CellMouseLeave(ByVal oSender As System.Object, _
	ByVal e As DataGridViewCellEventArgs) _
	...
	Private Sub Stretch(ByVal oSender As System.Object, _
	...
	Private Sub ZoomToImage(ByVal oSender As System.Object, _
	...
	Private Sub NormalImage(ByVal oSender As System.Object, ByVal e As EventArgs) Handles Button5.Click
	...
	Private Sub MakeCellsLarger(ByVal oSender As System.Object, ByVal e As EventArgs) Handles Button2.Click
