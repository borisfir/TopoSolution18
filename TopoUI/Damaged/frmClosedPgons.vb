...
#End Region
   ...
   End Sub
	...
	Private Sub zzCheckMPolygonSetAAA()
		...
		MessageBox.Show(ptMapThemeData.ClosedPgonsLayers & vbCrLf & ptDissolveMapThemeData.ClosedPgonsLayers, "07_130")
		mtTopoRes(0) = TopoManager.TopoCreator.CheckMPgons(ptMapThemeData.ClosedPgonsLayers, False)
		mtTopoRes(1) = TopoManager.TopoCreator.CheckMPgons(ptDissolveMapThemeData.ClosedPgonsLayers, False)


		MessageBox.Show(CStr(mtTopoRes(0).LinkCount) & vbCrLf & CStr(mtTopoRes(1).LinkCount), "07_131")
	...
	Public Sub New(tMapThemeData As DMAcadExt.MapThemeData)
		MyBase.New(tMapThemeData)
		miThisStagesUB = 0
      '	MessageBox.Show(tMapThemeData.TopoName & ":" & tDissolveMapThemeData.TopoName, "04_102")
   ...
   Private Sub zzDissolve()
      ...
      '   DMCommon.Debug.MsgBox("05_341a", ptDissolveMapThemeData.CentroidBlock, ptDissolveMapThemeData.CentroidLayer, ptDissolveMapThemeData.LinkLayer, ptDissolveMapThemeData.ClosedPgonsLayer)
   ...
   Private Sub zzCreateTopo(ByVal iIndex As Integer)
      ...
      Try
         TopoManager.TopoCreator.CreateTopology(ptMapThemeData.TopoName, ptMapThemeData.LinkLayers, "", ptMapThemeData.CentroidBlock, ptMapThemeData.CentroidLayer, True, String.Empty, String.Empty, False, False, dTolerance)
   ...
   Private Sub zzCheckTopo(bLockDoc As Boolean, ByVal bMsgBox As Boolean)
      mtTopoRes(0) = TopoManager.TopoCreator.CheckTopo(ptMapThemeData.TopoName, bLockDoc, bMsgBox)
   End Sub
   ...
   Private Sub mfParcelsFromShapes_FormClosed(ByVal oSender As System.Object, e As System.Windows.Forms.FormClosedEventArgs) Handles mfParcelsFromShapes.FormClosed
      '   MessageBox.Show(mfParcelsFromShapes.DialogResult.ToString(), "03_219")

      If mfParcelsFromShapes.DialogResult = Windows.Forms.DialogResult.OK AndAlso mfParcelsFromShapes.PoligonCount <> -1 Then

         ' MessageBox.Show(mfParcelsFromShapes.DialogResult.ToString() & vbCrLf & mfParcelsFromShapes.PoligonCount.ToString() & vbCrLf & mfParcelsFromShapes.Folder, "03_220")
         ...
         Else
            ...
            If oFileInfo.Exists Then
               ...
               moFDO_Manager = New FDO.FDO_Manager()
               '    DMCommon.Debug.MsgBox("07_030", sShapeFolderName, sShapeFileName, sClassName, mfParcelsFromShapes.MapThemeID, mfParcelsFromShapes.FilterList.List)
               moFDO_Manager.imp_Set(sShapeFileName, sShapeFolderName, sClassName, mfParcelsFromShapes.GushSet, mfParcelsFromShapes.MapThemeID, mfParcelsFromShapes.FilterList)
   ...
   Private Sub mfLotsFromShapes_FormClosed(oSender As System.Object, e As FormClosedEventArgs) Handles mfLotsFromShapes.FormClosed
      If mfLotsFromShapes.DialogResult = Windows.Forms.DialogResult.OK AndAlso mfLotsFromShapes.PoligonCount <> -1 Then
         ...
         If oFileInfo.Exists Then
            ...
            moFDO_Manager.imp_Set(sShapeFileName, sShapeFolderName, sClassName, Nothing, ptMapThemeData.MapThemeID, New DMCommon.dmList()) 'DMAcadExt.enMapTheme.LotApproved,
