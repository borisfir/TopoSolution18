...
#End Region
	...
	Public Sub New(tMapThemeData As DMAcadExt.MapThemeData, tSourceMapThemeData As DMAcadExt.MapThemeData, tOverlayMapThemeData As DMAcadExt.MapThemeData, Optional tOverlayMapThemeData_A As DMAcadExt.MapThemeData = Nothing)
		...
		Else
			...
			'DMCommon.Debug.MsgBox("07_510c", tMapThemeData.MapThemeID, tMapThemeData.SourceMapThemeID, tMapThemeData.OverlayMapThemeID, ptMapThemeData.MapLayer, ptSourceMapThemeData.MapLayer, ptOverlayMapThemeData.MapThemeID)
	...
	Private Sub tstTopology_ItemClicked(oSender As System.Object, e As System.Windows.Forms.ToolStripItemClickedEventArgs) Handles tstTopology.ItemClicked
		Dim taColor As System.Drawing.Color() = {New System.Drawing.Color(), System.Drawing.Color.FromArgb(255, 0, 0), System.Drawing.Color.FromArgb(0, 255, 0)}
		...
		Select Case e.ClickedItem.Name
			...
			Case Me.tsbExec.Name
				Select Case LabelCheck.CurrentIndex
					Case 0, 1, 2
						zzCreateMapLayer(LabelCheck.CurrentIndex, taColor(LabelCheck.CurrentIndex))
					Case 3
	...
	Private Sub zzCreateTopo(ByVal iIndex As Integer)
      ...
      Try
         Dim tMapThemeData As DMAcadExt.MapThemeData = zzGetMapThemeData(iIndex)
         tTopoRes = TopoManager.TopoCreator.CreateTopology(tMapThemeData.LineTopoName, tMapThemeData.MapThemeID, tMapThemeData.LinkLayers, tMapThemeData.LineLinkLayers, tMapThemeData.CentroidBlocks, tMapThemeData.CentroidLayers, bCreateCentroids, String.Empty, String.Empty, False, True, dTolerance)
	...
	Private Sub zzCheckTopo(ByVal iIndex As Integer, ByVal bMsg As Boolean)
      ...
      If oMapThemeData.GraphType = DMAcadExt.enGraphType.Topology OrElse oMapThemeData.GraphType = DMAcadExt.enGraphType.TopoOverlay Then
         tTopoRes = TopoManager.TopoCreator.CheckTopo(oMapThemeData.LineTopoName, False, bMsg, ptMapThemeData.MapThemeID)
      ElseIf oMapThemeData.GraphType = DMAcadExt.enGraphType.ClosedPolygons Then
         tTopoRes = TopoManager.TopoCreator.CheckMPgons(oMapThemeData.MPgonLayers, False)
      End If
      DMAcadExt.AcadTransaction.Terminate()
      DMAcadExt.AcadDocument.Unlock()
   ...
   End Sub
	...
	End Sub
	Private Sub zzCreateMapLayer(ByVal iIndex As Integer, tColor As System.Drawing.Color)
		Dim oMapThemeData As DMAcadExt.MapThemeData = zzGetMapThemeData(iIndex)
		...
		DMCommon.Debug.MsgBox("13_107", "zzCreateMapLayer", sExpCondition, oMapThemeData.GraphType, oMapThemeData.MapLayer, oMapThemeData.ShapeConnection, iIndex)
		oFDO_Manager.CreateMapLayer(sExpCondition, oMapThemeData.GraphType, oMapThemeData.MapLayer, oMapThemeData.ShapeConnection, CStr(iIndex), tColor)
	...
	End Sub
	Private Sub zzUnion()
		Dim sSourceLayer As String, sOverlayLayer As String, sResultLayer As String, sIntermediate As String
		...
		sIntermediate = ptMapThemeData.IntermediateLayer
		DMCommon.Debug.MsgBox("zzUN 147cc", sSourceLayer, sOverlayLayer, sResultLayer, sIntermediate, ptMapThemeData.TopoName, ptMapThemeData.MapThemeID, mbAddOverlayExists)
		If mbAddOverlayExists Then
			sOverlayLayer_A = ptOverlayMapThemeData_A.MapLayer
			sResultLayer_A = sIntermediate
		End If

		If mbAddOverlayExists Then
			msIntermediateLayer = sResultLayer_A
			sSHPFileName = oFDO_Manager.Union(sSourceLayer, sOverlayLayer, msIntermediateLayer, dMinFDOSliverTolerance, dMaxFDOSliverTolerance)
			...
			oFDO_Manager.ConnectToShape(msIntermediateLayer, System.Drawing.Color.FromArgb(255, 255, 0))
			Dim saParseVal() As String = Strings.Split(sSHPFileName, ".")
				msIntermediateConnection = "shp_" & saParseVal(0)
			...
			DMCommon.Debug.MsgBox("zzUN 142ax", ptMapThemeData.MapThemeID, ptMapThemeData.TopoName, sSourceLayer, sOverlayLayer, sResultLayer_A, sOverlayLayer_A, sResultLayer, dMinFDOSliverTolerance, dMaxFDOSliverTolerance)
