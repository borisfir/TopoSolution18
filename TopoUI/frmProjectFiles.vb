...
Public Class frmProjectFiles
   ...
   Private Sub zzCreatePgonSet()
      ...
      If moPgonSet Is Nothing Then
			'  MessageBox.Show(Me.Name & vbCrLf & "zzCreatePgonSet", "05_370c")
			Dim bCurrentLayerOK As Boolean = False

			'   System.Windows.Forms.MessageBox.Show(ptMapThemeData.MapThemeID.ToString & vbCrLf & ptMapThemeData.TopoPurpose.ToString & vbCrLf & ptMapThemeData.TopoName & vbCrLf & ptMapThemeData.ClosedPgonsLayers, "07_001u")
