...
#End Region
	...
	Private Sub zzBreakCreate()
      ...
      Dim iMapThemeID As DMAcadExt.enMapTheme = DMAcadExt.enMapTheme.AnalyticInParcels
      Dim tTopoRes As DMAcadExt.TopoRes = TopoManager.TopoCreator.CreateTopology(sTopoName, iMapThemeID, ptOverlayMapThemeData.LinkLayers, "", ptSourceMapThemeData.CentroidBlocks, ptSourceMapThemeData.CentroidLayers, False, String.Empty, String.Empty, False, False, 0.05)
	...
	Private Sub zzCreateTopo(ByVal iIndex As Integer)
		...
		Try
         ...
         Dim iMapThemeID As DMAcadExt.enMapTheme = DMAcadExt.enMapTheme.AnalyticInParcels
         tTopoRes = TopoManager.TopoCreator.CreateTopology(ptOverlayMapThemeData.TopoName, iMapThemeID, ptOverlayMapThemeData.LinkLayers, ptOverlayMapThemeData.LineLinkLayers, ptOverlayMapThemeData.CentroidBlocks, ptOverlayMapThemeData.CentroidLayers, bCreateCentroids, String.Empty, String.Empty, False, True, dTolerance)
	...
	Private Sub zzCheckTopo(ByVal iIndex As Integer, ByVal bMsg As Boolean)
		...
		If oMapThemeData.GraphType = DMAcadExt.enGraphType.Topology Then
         tTopoRes = TopoManager.TopoCreator.CheckTopo(oMapThemeData.LineTopoName, True, bMsg, ptMapThemeData.MapThemeID)
	...
	Private Sub zzCreateMapLayer(ByVal bSource As Boolean)
		...
		oFDO_Manager.CreateMapLayer(sExpCondition, oMapThemeData.GraphType, oMapThemeData.MapLayer, oMapThemeData.ShapeConnection, "", New System.Drawing.Color)
...
#End Region
	...
	Private Sub zzSetCleanupErrPoints(ByVal iCleanupIndex As Integer)
		...
		If oDataRow.IsNull(msPointsFldName) Then
			...
			iErrorCount = 0
		Else
			Dim oDin As System.Object = oDataRow.Item(msPointsFldName)
			If False Then
