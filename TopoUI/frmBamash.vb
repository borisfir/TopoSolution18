...
Public Class frmBamash
 ...
 , TPlServerDB.enResourceTheme.AcRepBamashAfricaData}
	...
	End Sub
	Private Sub zzUpdateParcel(sParcelNew As String)
		Dim oXrecord As DatabaseServices.Xrecord
		...
		If Not String.IsNullOrEmpty(msDictionaryParcel) Then
			If sParcelNew <> msDictionaryParcel Then
		...
		If bAddNew Then
			...
			Try
				oXrecord.Data = DMAcadExt.AcadUtil.GetResBuffer(sParcelNew, False)
	...
	Private Sub zzInsertReport()
		...
		If doSelectedReportItem IsNot Nothing Then
			...
			If oDataView IsNot Nothing Then
				zzInsertReportA(oDataView, iaDataColumns, oaTotals, oaOptionValues, iaEmptyColumns)
	...
	End Sub
	Private Sub zzInsertReportA(ByVal oDataView As DataView, ByVal iaDataColumns() As Integer, ByVal oaTotals() As System.Object, ByVal oaOptionValues() As System.Object, Optional ByVal iaEmptyColumns() As Integer = Nothing)
		If oDataView IsNot Nothing Then
		...
		If oBamashTopology IsNot Nothing Then
			...
			Do
				...
				If iSelectPointStatus = Autodesk.AutoCAD.EditorInput.PromptStatus.OK Then
					...
					End Try
					iSelectKeywordStatus = zzGetPropertyType(iPropertyType, bNext)
	...
	Private Sub cmdSelectByPick_Click(oSender As System.Object, e As EventArgs) Handles cmdSelectByPick.Click
		...
		Select Case Me.cmbNumerationPropID.SelectedIndex
			Case 0
				zzSelectByPick_Al1(False)
			Case 1
				zzSelectByPick_Al1(True)
			Case 2
				zzSelectByPick_Al2(False)
			Case 3
				bmBamash.SubpropNumeration(False)
			Case 4
				zzSelectByPick_Al3()
			Case 5
	...
	Private Function zzSelectBamashPgon(ByRef oBamashPgon As BamashPolygon, ByRef oBamashTopology As Autodesk.Gis.Map.Topology.TopologyModel, Optional sAddMsg As String = Nothing) As Autodesk.AutoCAD.EditorInput.PromptStatus
		...
		Do
			...
			'DMCommon.Debug.MsgBox("!zzSelectBamashPgon", iSelectPointStatus, bOneOnly)
			If iSelectPointStatus = Autodesk.AutoCAD.EditorInput.PromptStatus.OK Then
	...
	End Function
	'zzGetPropertyType
	Private Function zzGetPropertyType(ByRef iPropertyType As enPropertyTypes, ByRef bNext As Boolean) As Autodesk.AutoCAD.EditorInput.PromptStatus
	...
	Private Sub cmdRefreshMinMaxProprtyID_Click(oSender As System.Object, e As EventArgs) Handles cmdRefreshMinMaxProprtyID.Click
