...
Public Class prjPrograms
	Public Shared Sub GazAddOD()
		...
		If oCurrentDataView IsNot Nothing Then
			...
			oCurrentDataView.Sort = TopoManager.TPlanGraph.TplnParcel.NameFieldName & "," & sLotTopoID
			For Each oRowView As System.Data.DataRowView In oCurrentDataView
				sTest = "A"
				iParcelID = Convert.ToInt32(DirectCast(oRowView.Item(TopoManager.TPlanGraph.TplnParcel.NameFieldName), String))
				...
				End If
				sLotName = DMCommon.Functions.CStrN(oRowView.Item(TopoManager.TPlanGraph.TplnLot.NameFieldName))
