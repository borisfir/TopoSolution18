...
Public Class frmBamashM
	...
	Private miNumberingSeparately As Integer
 ...
 , TPlServerDB.enResourceTheme.AcRepBamashAfricaData}
	...
	Private Sub zzGetDictionaryParcel()
		...
		If Not mbDicIsNew AndAlso mdicMain.Contains(msDictionaryKey) Then
			...
			If oXrecord IsNot Nothing Then
				...
				End If
				If oaTypedValue.GetUpperBound(0) >= 3 Then
					miNumberingSeparately = DirectCast(oaTypedValue(3).Value, Integer)
				End If
	...
	Private Sub zzUpdateData()
		...
		Dim bNumberingSeparatelyNew As Boolean = Me.chkNumberingSeparately.Checked
		Dim iNumberingSeparately As Integer = CInt(bNumberingSeparatelyNew)
		...
		Dim oNewData() As System.Object = {sParcelNew, dBreakHeightNew, dSpacingNew, iNumberingSeparately}
		...
		If Not String.IsNullOrEmpty(msDictionaryParcel) Then
			If sParcelNew <> msDictionaryParcel OrElse dBreakHeightNew <> mdBreakHeight OrElse dSpacingNew <> mdSpacing OrElse bNumberingSeparatelyNew <> CBool(miNumberingSeparately) Then
	...
	Private Sub zzOpenDictionary(ByVal bCreate As Boolean, ByVal bReadOnly As Boolean)
		...
		End If
		Me.chkNumberingSeparately.Checked = CBool(miNumberingSeparately)
		DMAcadExt.AcadTransaction.Terminate()
		DMAcadExt.AcadDocument.Unlock()
	End Sub
	...
	Private Sub cmdCalculate_Click(ByVal oSender As System.Object, ByVal e As System.EventArgs) Handles cmdCalculate.Click
		...
		End If
		BamashPolygon.NumberingSeparately = Me.chkNumberingSeparately.Checked
	...
	Private Sub zzInsertTableReport(ByVal oDataView As DataView, ByVal iaDataColumns() As Integer, ByVal oaTotals() As System.Object, ByVal oaOptionValues() As System.Object, Optional ByVal iaEmptyColumns() As Integer = Nothing)
		If oDataView IsNot Nothing Then
			...
			If oRepApp.Open(doSelectedReportItem.RepIndex) Then
				...
				DMCommon.Debug.ExcelLog.SetDataTable(0, "!MainRep" & CStr(dbAutocad), oDataView, 10)
	...
	Private Sub cmdSelectByPick_Click(oSender As System.Object, e As EventArgs) Handles cmdSelectByPick.Click
		...
		Select Case Me.cmbNumerationPropID.SelectedIndex
			...
			Case 3
				BamashPolygon.NumberingSeparately = Me.chkNumberingSeparately.Checked
				bmBamash.SubpropNumeration(Me.chkNumberingSeparately.Checked)
			Case 4
				zzSelectByPick_Al3()
			Case 5
	...
	Private Sub txtParcelNo_TextChanged(sender As Object, e As EventArgs) Handles txtParcelNo.TextChanged

	End Sub

	Private Sub chkNumberingSeparately_CheckedChanged(sender As Object, e As EventArgs) Handles chkNumberingSeparately.CheckedChanged

	End Sub

	Private Sub tpgEditBloks_Click(sender As Object, e As EventArgs) Handles tpgEditBloks.Click
