...
Public Class frmMapThemeBase
   ...
   Protected piLabelTop As Integer = 64
   Protected piLabelLeft As Integer = 302
   ...
   Protected Const msToleranceFldName As String = "Tolerance"
	...
	Protected Const msErrorsAddFldName As String = "ErrorsAdd"
   ...
   Protected Const msPaintStraightenSettingKey As String = "PaintStraighten"
	Protected Const msCheckErrorFldName As String = "CheckError"
...
#End Region
   ...
   Public Sub New(tMapThemeData As DMAcadExt.MapThemeData)
		'	DMCommon.Debug.MsgBox("07_422", tMapThemeData.MapThemeID, tMapThemeData.TopoName, tMapThemeData.LineTopoName)
   ...
   End Sub
	...
	Public MustOverride Sub ExecDefaultAction()
   ...
   Private Sub zzInitMoveButtons()
		Const iButtonsY As Integer = 248 + 8
   ...
   Private Function zzSetGridColumns(iIndex As Integer) As System.Windows.Forms.DataGridViewComboBoxColumn
      DMCommon.Debug.MsgBox("12_305", iIndex)
   ...
   Private Sub zzInitLabelChecks()
      ...
      For iIndex As Integer = 0 To piStagesUB
         ...
         doaLabelCheck(iIndex).Location = New System.Drawing.Point(piLabelLeft, piLabelTop + iIndex * 32)
